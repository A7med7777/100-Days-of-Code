...
... and so on
```
The central idea behind this project is to be able to use BeautifulSoup to get some data - like movie titles—from a website like Empire's (or from, say Timeout or Stacker that have curated similar lists). 
